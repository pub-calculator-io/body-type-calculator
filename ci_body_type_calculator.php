...
Version: 1.0.0
Author: Body Type Calculator / www.calculator.io
...
function display_calcio_ci_body_type_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_body_type_calculator', 'display_calcio_ci_body_type_calculator' );